...
float latitude[2][14]={48.866667,43.7009358,43.2961743,43.6112422,43.6044622,44.841225,43.4832523,46.1591126,46.5802596,48.1113387,48.3905283,50.6365654,49.2577886,
48.866667,48.2971626,47.7961287,47.3215806,47.2380222,45.7578137,45.4401467,45.1875602,44.9332277,43.9492493,43.8374249,44.5612032,43.1257311,38.1458689,48.866667};  
float longitude[2][14]={2.333333,7.2683912,5.3699525,3.8767337,1.4442469,0.5800364,1.5592776,1.1520434,0.340196,1.6800198,4.4860088,3.0635282,4.031926,
2.333333,4.0746257,3.570579,5.0414701,6.0243622,4.8320114,4.3873058,5.7357819,4.8920811,4.8059012,4.3600687,6.0820639,5.9304919,-7.3668309,2.333333}   ;
...
//printf ("\r\n Temps=%d, table=%d, Pression=%d, latitude=%f longitude=%f ", Temps,Num_Table,PRESSION[Temps][Num_Table],latitude[Temps%2][Num_Table],longitude[Temps%2][Num_Table] );
   printf ("\r\n Temps=%d, table=%d, Pression=%f, latitude=%f longitude=%f ", Temps,Num_Table,PRESSION[Temps][Num_Table],latitude[Temps%2][Num_Table],longitude[Temps%2][Num_Table] );
    ...
    size =size+ Payload.addSismique(2,SISMIQUE[Temps][Num_Table]);    // Add Temp in payload
